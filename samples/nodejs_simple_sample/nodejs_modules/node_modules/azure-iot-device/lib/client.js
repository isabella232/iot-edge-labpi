...
var Client = (function (_super) {
            ...
            states: {
                ...
                'connected': {
                    _onEnter: function () {
                        ...
                        _this._transport.getReceiver(function (err, receiver) {
                            if (err) {
                                _this.emit('error', err);
                            }
                            else {
                                _this._receiver = receiver;
                                _this._receiver.on('errorReceived', function (err) {
                                    _this.emit('error', err);
                                });
                                ...
                                if (Object.keys(_this._methodCallbackMap).length > 0) {
                                    ...
                                    for (var methodName in _this._methodCallbackMap) {
                                        if (_this._methodCallbackMap.hasOwnProperty(methodName)) {
                                            var callback = _this._methodCallbackMap[methodName];
                    ...
                    startMessageReceiver: function () {
                        /*Codes_SRS_NODE_DEVICE_CLIENT_16_065: [The client shall connect the transport if needed to subscribe receive messages.]*/
                        if (!_this._messageReceiverConnected) {
                            _this._connectMessageReceiver();
                        }
                    },
    ...
    Client.prototype._disconnectMessageReceiver = function () {
        if (this._receiver) {
            this._receiver.removeAllListeners('message');
            this._messageReceiverConnected = false;
        }
    };
    Client.prototype._destroyReceiver = function () {
        if (this._receiver) {
